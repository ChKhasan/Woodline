    ...
    <div class="row pb-6">
      <div class="col-md-6 mb-8 mb-md-0">
        <a href="">
          <img
            ...
            src="../../public/images/product-13_3.jpg"
            alt=""
          />
        </a>
        <a href="">
      ...
      <div class="pt-3 mr-40 col-md-5 pl-md-6 pl-lg-0">
        <div class="content-right primary-summary summary-sticky">
          ...
          <h2 class="body_title fs-30 fs-lg-40 mb-2">Tuck Bar Stool</h2>
          ...
          <p class="mt-3 mb-6 body_card_info">
            Minimal, yet bold - LYNEA Plug Lamp adds an architectural addition
            without the pain of a professional installation.
          </p>
          <img
            class="img_catchap"
            src="../../public/images/product-page-09.jpg"
            alt=""
          />
          <form>
          ...
          <ul class="list-unstyled mt-5">
            <li class="row mb-2">
              <span class="d-block col-3 font-weight-500 fs-15">SKU:</span>
              <span class="d-block col-9 fs-15 color-gray">N/A</span>
            </li>
            <li class="row mb-2">
